      ...
      <Card key="Theaveragerating" style={styles.card}>
        <View style={styles.average}>
          ...
          <Text style={styles.averageTitle}>
            {i18n.translate('The average rating')}
          </Text>
          <Text style={styles.averageRating}>
            {isEmpty(props.average) ? 0 : props.average}/5
          </Text>
        </View>
      </Card>
