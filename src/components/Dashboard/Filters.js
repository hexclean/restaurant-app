...
export default Filters = props => {
  ...
  const [withinOneHour, setWithinOneHour] = useState(
    props.filters.withinOneHour,
  );
    ...
    <Content style={styles.content}>
      ...
      <Card key="result1" style={styles.card}>
        ...
        <View key="filter1" style={styles.itemView}>
          <TouchableOpacity
            style={[
              styles.itemButton,
              hamburger ? common.borderColorYellow : null,
            ]}
            onPress={() => setHamburger(!hamburger)}>
            <Text style={[styles.itemText, hamburger ? styles.itemBold : null]}>
              {i18n.translate('Hamburger')}
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[styles.itemButton, pizza ? common.borderColorYellow : null]}
            onPress={() => setPizza(!pizza)}>
            <Text style={[styles.itemText, pizza ? styles.itemBold : null]}>
              {i18n.translate('Pizza')}
            </Text>
          </TouchableOpacity>
        </View>
        <View key="filter2" style={styles.itemView}>
          <TouchableOpacity
            style={[styles.itemButton, soup ? common.borderColorYellow : null]}
            onPress={() => setSoup(!soup)}>
            <Text style={[styles.itemText, soup ? styles.itemBold : null]}>
              {i18n.translate('Soup')}
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[
              styles.itemButton,
              dailyMenu ? common.borderColorYellow : null,
            ]}
            onPress={() => setDailyMenu(!dailyMenu)}>
            <Text style={[styles.itemText, dailyMenu ? styles.itemBold : null]}>
              {i18n.translate('Daily menu')}
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[styles.itemButton, salad ? common.borderColorYellow : null]}
            onPress={() => setSalad(!salad)}>
            <Text style={[styles.itemText, salad ? styles.itemBold : null]}>
              {i18n.translate('Salat')}
            </Text>
          </TouchableOpacity>
        </View>
      </Card>
      <Card key="result2" style={styles.card}>
        ...
        <View key="filter3" style={styles.itemView}>
          <TouchableOpacity
            style={[
              styles.itemButton,
              freeDelivery ? common.borderColorYellow : null,
            ]}
            onPress={() => setFreeDelivery(!freeDelivery)}>
            <Text
              style={[styles.itemText, freeDelivery ? styles.itemBold : null]}>
              {i18n.translate('No shipping costs')}
            </Text>
          </TouchableOpacity>
        </View>
        <View key="filter4" style={styles.itemView}>
          <TouchableOpacity
            style={[
              styles.itemButton,
              newest ? common.borderColorYellow : null,
            ]}
            onPress={() => setNewest(!newest)}>
            <Text style={[styles.itemText, newest ? styles.itemBold : null]}>
              {i18n.translate('News')}
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[
              styles.itemButton,
              withinOneHour ? common.borderColorYellow : null,
            ]}
            onPress={() => setWithinOneHour(!withinOneHour)}>
            <Text
              style={[styles.itemText, withinOneHour ? styles.itemBold : null]}>
              {i18n.translate('Within 1 hour')}
            </Text>
          </TouchableOpacity>
        </View>
      </Card>
      <Card key="result3" style={styles.card}>
        <Text style={styles.cardTitle}>
          {i18n.translate('Payment options')}
        </Text>
        <View key="filter5" style={styles.itemView}>
          <TouchableOpacity
            style={[styles.itemButton, money ? common.borderColorYellow : null]}
            onPress={() => setMoney(!money)}>
            <Text style={[styles.itemText, money ? styles.itemBold : null]}>
              {i18n.translate('Cash')}
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[styles.itemButton, card ? common.borderColorYellow : null]}
            onPress={() => setCard(!card)}>
            <Text style={[styles.itemText, card ? styles.itemBold : null]}>
              {i18n.translate('Card')}
            </Text>
          </TouchableOpacity>
        </View>
