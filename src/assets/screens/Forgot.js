        ...
        <View style={styles.inputView}>
          ...
          <TextField
            ...
            containerStyle={[
              ...
              {
                borderColor: !isEmpty(errorEmail)
                  ? colors.RED.PRIMARY
                  : colors.GREY.PRIMARY,
              },
            ]}
        ...
        <View style={[styles.buttonView, {marginTop: 35}]}>
          <TouchableOpacity
            ...
            style={[
              ...
              {
                backgroundColor:
                  isEmpty(email) || !isEmpty(errorEmail)
                    ? colors.GREY.PRIMARY
...
const Verification = props => {
  ...
  return (
    <View
      style={[styles.confirmView, {display: props.visible ? 'flex' : 'none'}]}>
      <View style={styles.opacityView} />
      <View style={styles.confirmModal}>
        <Text style={styles.confirmTitle}>Verification Code</Text>
        <Text style={styles.confirmDescription}>
          A message with a verification code has been sent to your email for
          reset password. Enter the code to continue.
        </Text>
        <CodeInput
          codeLength={6}
          size={50}
