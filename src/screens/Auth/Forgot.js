      ...
      <Header style={common.header}>
        ...
        <View style={common.headerTitle}>
          <Text style={common.headerTitleText}>
            {i18n.translate('Forgotten Password')}
          </Text>
        </View>
        ...
        {!visible ? (
          <Fragment>
            {isEmpty(errorMsg) ? (
              <Text style={styles.descriptionText}>
                {i18n.translate(
                  'Please enter your email address to send us your new password',
                )}
              </Text>
            ) : (
            ...
            <View style={[styles.buttonView, common.marginTop50]}>
              <TouchableOpacity
                disabled={
                  isEmpty(email) || !isEmpty(errorEmail) || visible
                    ? true
                    : false
                }
                style={[
          ...
          <Fragment>
            <View style={styles.inputView}>
              {isEmpty(errorMsg) ? (
                <Fragment>
                  <Text style={[styles.labelText, common.width100P]}>
                    {i18n.translate('Confirm Verification Code')}
                  </Text>
                  <Text style={styles.confirmText}>
                    {i18n.translate(
                      'If you do not receive the email, you can resend it in 45 seconds',
                    )}
                  </Text>
                </Fragment>
              ) : (
              ...
              <View style={styles.bottomView}>
                <TouchableOpacity
                  ...
                  style={[
                    common.button,
                    resend ? common.backColorYellow : common.backColorGrey,
                  ]}
                  onPress={() => onVerification()}>
                  <Text style={[common.buttonText, common.fontColorWhite]}>
                    {i18n.translate('Resend')}
                  </Text>
                </TouchableOpacity>
                <TouchableOpacity
                  style={[common.button, common.backColorYellow]}
