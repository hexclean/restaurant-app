...
export default SignUp = props => {
  ...
  useEffect(() => {
    setErrorMsg('');
    (visitName && isEmpty(name)) || (visitName && !validateName(name))
      ? setErrorName(
    ...
    (visitEmail && isEmpty(email)) || (visitEmail && !validateEmail(email))
      ...
      : setErrorEmail('');
    (visitMobile && isEmpty(mobile)) || (visitMobile && !validateMobile(mobile))
      ? setErrorMobile(i18n.translate('Mobile is not valid'))
      : setErrorMobile('');
    (visitPassword && isEmpty(password)) ||
    (visitPassword && !validatePassword(password))
      ? setErrorPassword(
          i18n.translate('The password must be at least 6 characters long'),
        )
      : setErrorPassword('');
      ...
      <Content style={styles.content}>
        ...
        <View style={styles.inputView}>
          <Text
            style={[
              styles.labelText,
              !isEmpty(errorName) ? common.fontColorRed : common.fontColorBlack,
            ]}>
            {i18n.translate('Name')}
          </Text>
          <TextField
        ...
        <TouchableOpacity
          ...
          <Icon
            ...
            name={
              termOfService ? 'check-box-outline' : 'checkbox-blank-outline'
            }
            size={25}
          ...
          <Text style={styles.rememberText}>
            ...
            <Text
              ...
              onPress={() => Linking.openURL('http://foodnet.ro/ro/terms')}>
        ...
        <TouchableOpacity
          ...
          <Text style={styles.rememberText}>
            ...
            <Text
              ...
              onPress={() => Linking.openURL('http://foodnet.ro/ro/privacy')}>
              {i18n.translate('Privacy')}
            </Text>
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={[styles.rememberMe, common.marginTop10]}
          ...
          />
          <Text style={styles.rememberText}>
            {i18n.translate('I subscribe to the newsletter')}
          </Text>
        </TouchableOpacity>
