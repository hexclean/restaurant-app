...
export default ProfileEdit = props => {
  ...
  const [mobile, setMobile] = useState(
    isEmpty(props.route.params.userInfo.phoneNumber)
      ? ''
      : props.route.params.userInfo.phoneNumber,
  );
  ...
  useEffect(() => {
    ...
    (visitName && isEmpty(name)) || (visitName && !validateName(name))
      ? setErrorName('The name must be at least 3 characters long')
      : setErrorName('');
