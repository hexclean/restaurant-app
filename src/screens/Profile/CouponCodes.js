    ...
    <Container style={common.container}>
      ...
      <Content style={styles.content}>
        ...
        <Text style={styles.fenText}>
          {i18n.translate('Fennmaradt egyenleged')}:{' '}
          <Text style={styles.yellowText}>12345FT</Text>
        </Text>
        <View style={styles.textContainer}>
          <Text style={styles.fenText}>
            {i18n.translate('Your current subscription')}:{' '}
            <Text style={styles.yellowText}>Ingyenes</Text>
          </Text>
        </View>
        <View style={styles.buttonView}>
          <Text style={styles.yellowTitle}>
            2. {i18n.translate('Package name')}
          </Text>
          <Text style={styles.normalText}>
            Havi 1200 {i18n.translate('lei')}
          </Text>
