    ...
    <Container style={common.container}>
            ...
            <FlatList
              ...
              renderItem={(upSellProduct, index) => (
                <UpSellProductItem
                  ...
                  onSelectUpSellProduct={item => onSelectUpSellProduct(item)}
                />
              )}
            />
          </Fragment>
      ...
      <View style={styles.goToOrder}>
        <View style={styles.amount}>
          <Text style={styles.orderPrice}>{i18n.translate('Total')}</Text>
        ...
        <View style={styles.orderButtonView}>
          <TouchableOpacity
            style={[styles.button, disabled ? common.backColorGrey : '#F78F1E']}
            disabled={disabled}
            onPress={() => {
              setDisabled(true);
              setNavi(false);
