    ...
    return (
      <View key={index} style={styles.address}>
        <Text style={styles.addressText}>
          {address.item.doorNumber}, {address.item.floor},{' '}
          {address.item.houseNumber}, {address.item.street}, {address.item.city}
        </Text>
        <View style={styles.addressOption}>
          <TouchableOpacity
            onPress={() =>
              props.navigation.push('DeliveryAdd', {
                type: 2,
                item: address.item,
              })
            }>
      ...
      <Header style={common.header}>
        ...
        <TouchableOpacity style={common.headerTitle}>
          <Text style={common.headerTitleText} numberOfLines={1}>
            {i18n.translate('Delivery addresses')}
          </Text>
        </TouchableOpacity>
        <View style={common.headerRight}>
          <TouchableOpacity
            onPress={() =>
              props.navigation.push('DeliveryAdd', {type: 1, item: null})
            }>
            <Icon
